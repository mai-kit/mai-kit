...
`@mai-kit/judgement-inference` is distributed under GPL-3.0-only.

The package includes its TypeScript source in `src/`. The complete corresponding source for each
